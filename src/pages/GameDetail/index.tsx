...
const GameDetailPage: React.FC = () => {
  ...
  // }, [id]);
  const gameData = mockGames.find(game => game.id === _id) || mockGames[0];
  ...
  const tabItems: TabsProps['items'] = [
    {
      ...
      children: (
        <TabContent>
          <p style={{ whiteSpace: 'pre-line' }}>{gameData.description}</p>
  ...
  return (
    <DetailContainer>
      <GameHeader>
        <GameImageContainer>
          <img src={gameData.coverImage} alt={gameData.title} style={{ width: '100%' }} />
        </GameImageContainer>
        ...
        <GameInfo>
          ...
          <GameDescription>{gameData.shortDescription}</GameDescription>
